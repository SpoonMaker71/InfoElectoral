' ---------------------------------------------------------------
' Módulo: modGlobal.bas
' Autor: Juan Francisco Cucharero Cabezas
' Proyecto: InfoElectoral
' Descripción:
'   Contiene constantes, rutas, variables públicas y configuraciones
'   compartidas por los distintos módulos y formularios del sistema.
'
'   ⚠️ Este módulo no contiene lógica de negocio ni interacción directa.
'   Su propósito es servir como punto central de referencia para
'   valores reutilizables y configuraciones globales.
'
' Fecha: [añadir fecha]
' ---------------------------------------------------------------
